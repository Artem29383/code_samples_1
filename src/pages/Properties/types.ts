...
export const halfListWidth = 617;
...
export const filtersViewsTransitions: ViewsTransitions = {
  ...
  'to-map-list-up': { ease: 'linear', duration: 0.6 },
  'to-map-list-down': { ease: 'linear', duration: 0.6 },
};
...
export const filtersViewVariants: ViewsVariants = {
  ...
  'to-map-list-up': 'swipeUp',
  'to-map-list-down': 'swipeDown',
  default: 'closed',
};

export const filtersViewVariantsInitial: ViewsVariants = {
  'map-filters': 'open',
  'list-filters': 'open',
  'to-list-filters': 'open',
  'to-map-list-up': 'beforeSwipeUp',
  'to-map-list-down': 'swipeDown',
  default: 'closed',
};
